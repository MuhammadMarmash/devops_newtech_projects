...
The operational deep-dive: what to check before you apply, what each stage actually does,
how to verify a deployment stage by stage, how to troubleshoot it when a stage fails, and
the full phase-by-phase design rationale. Start at the [project README](../README.md) for
the pitch and the quick start — this is the reference you come back to once something needs
a closer look.
