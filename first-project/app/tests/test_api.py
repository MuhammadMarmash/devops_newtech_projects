...
class TestAPIEndpoints:
    ...
    def test_create_todo_success(self, client):
        ...
        response = client.post(
            "/api/todos", data=json.dumps(payload), content_type="application/json"
        )
    ...
    def test_create_todo_missing_title(self, client):
        ...
        payload = {"description": "Description only"}
        response = client.post(
            "/api/todos", data=json.dumps(payload), content_type="application/json"
        )
    ...
    def test_update_todo_not_found(self, client):
        ...
        response = client.put(
            "/api/todos/999", data=json.dumps(payload), content_type="application/json"
        )
    ...
    def test_update_todo_no_data(self, client):
        ...
        response = client.put(f"/api/todos/{todo_id}", content_type="application/json")
